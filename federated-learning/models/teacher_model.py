...
class ConvNet(nn.Module):
    def __init__(self,args):#,args
        ...
        self.conv4 = MaskedConv2d(128, 256, kernel_size=3, padding=1, stride=1)
        self.relu4 = nn.ReLU(inplace=True)
        self.maxpool4 = nn.MaxPool2d(2)

        self.conv5 = MaskedConv2d(256, 512, kernel_size=3, padding=1, stride=1)
        self.relu5 = nn.ReLU(inplace=True)
        self.maxpool5 = nn.MaxPool2d(2)

        self.conv6 = MaskedConv2d(512, 512, kernel_size=3, padding=1, stride=1)
    ...
    def forward(self, x):
        ...
        out = self.maxpool5(self.relu5(self.conv5(out)))
